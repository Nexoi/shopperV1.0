...
//
//        );
//        genCode("order", "order_basic", "order_log", "order_product", "order_receiver");
//        genCode("user", "user_login", "user_address", "user_coupon", "user_favorite", "user_info");
//        genCode("config", "config_order_rule");
        genCode("third", "third1");
//        genCode("support", "support_cate");
